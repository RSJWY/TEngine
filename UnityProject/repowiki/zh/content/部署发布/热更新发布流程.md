...
> **当前 Fork 基线**：发布流程以 `UpdateSetting.RuntimePackages` 为唯一包配置源，程序集包可使用 `ArchiveFileBuildPipeline`。构建产物优先进入 `Releases/`，热更二进制按 Archive/非 Archive 管线分别读取 `RawFileObject`/`TextAsset`。参见 [当前 Fork 定制功能](../项目概述/当前Fork定制功能.md)。
