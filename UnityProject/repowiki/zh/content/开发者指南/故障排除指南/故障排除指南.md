...
> **当前 Fork 提示**：资源、热更新和配置问题应先核对 YooAsset 3、`RuntimePackages`、Archive 程序集包以及 `RuntimeConfigModule`。本文中 `AssemblyTextAssetPath` 和 Luban 默认配置等旧描述不代表当前基线。参见 [当前 Fork 定制功能](../../项目概述/当前Fork定制功能.md)。
