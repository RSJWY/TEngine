...
> **当前 Fork 提示**：如果插件字节来自热更新程序集包，Archive 管线读取 `RawFileObject`，其他管线才读取 `TextAsset`。程序集包名和目录必须来自 `UpdateSetting`，不要硬编码旧 `AssemblyTextAssetPath`。参见 [当前 Fork 定制功能](../../项目概述/当前Fork定制功能.md)。
