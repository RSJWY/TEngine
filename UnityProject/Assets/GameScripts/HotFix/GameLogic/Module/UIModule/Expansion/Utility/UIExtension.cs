...
namespace GameLogic
{
    public static class UIExtension
    {
        ...
        {
            return EaseUtil.FadeToAlphaAsync(canvasGroup, targetAlpha, duration, callback, cancellationToken, easeType, false);
        }
        ...
        public static UniTask<CanvasGroup> FadeToAlphaAsyncUnscaled(this CanvasGroup canvasGroup, float targetAlpha, float duration,
            ...
            EaseType easeType = EaseType.Linear)
        {
            return EaseUtil.FadeToAlphaAsync(canvasGroup, targetAlpha, duration, callback, cancellationToken, easeType, true);
        }
        ...
        public static UniTask<Slider> SmoothValue(this Slider slider, float targetValue, float duration = 0.3f,
            ...
            EaseType easeType = EaseType.Linear)
        {
            return EaseUtil.SmoothValue(slider, targetValue, duration, callback, cancellationToken,
                easeType);
        }
        ...
        public static UniTask<Image> SmoothValue(this Image image, float targetValue, float duration = 0.3f,
            Action callback = null, CancellationToken cancellationToken = default)
        {
            return EaseUtil.SmoothValue(image, targetValue, duration, callback, cancellationToken);
        }

        public static UniTask<Scrollbar> SmoothValue(this Scrollbar scrollbar, float targetValue, float duration = 0.3f,
            Action callback = null, CancellationToken cancellationToken = default)
        {
            return EaseUtil.SmoothValue(scrollbar, targetValue, duration, callback, cancellationToken);
        }

        public static bool TryGetMouseDownUIPos(this UIModule uiModule, out Vector2 screenPos)
        {
            return TryGetMouseDownUIPos((RectTransform)UIModule.UIRoot, UIModule.Instance.UICamera, out screenPos);
        }

        private static bool TryGetMouseDownUIPos(RectTransform uiRoot, Camera uiCamera, out Vector2 screenPos)
        {
