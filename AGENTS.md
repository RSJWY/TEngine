...
| Luban 配置结构、数据、导出及分片（本项目默认未启用，用户主动要求时才使用） | [luban-dev](UnityProject/.codex/skills/luban-dev/SKILL.md) |
| HTML/UI-DSL 转 UGUI Prefab | [html-to-ugui](UnityProject/.codex/skills/html-to-ugui/SKILL.md) |
| 本 Fork 定制改动文档维护（README 概览、Books/Fork、CHANGELOG） | [fork-docs](UnityProject/.codex/skills/fork-docs/SKILL.md) |
...
- 不使用旧的规范管理工具。其他项目/用途的全局技能不属于本仓库依赖。
...
新增 fork 定制功能时（经用户同意后）按分层文档规则更新：
- `README.md` 的「🛠️ 本 Fork 的定制改动」只维护简短概览；
- `Books/Fork-定制改动说明.md` 只作为兼容索引入口；
